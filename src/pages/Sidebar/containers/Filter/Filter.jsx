        ...
        return (
            <React.Fragment>
                <Dropdown className="Filter" >
                    ...
                    <Dropdown.Menu >
                        &nbsp;Site scope
                    <Dropdown.Item as="button" toggle={false} eventKey="siteScope:onPage" onSelect={eventKey => this.updateSelected(eventKey)}>
                            On page {this.selection.siteScope.includes('onPage') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="siteScope:anchorToPage" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Anchored to Page {this.selection.siteScope.includes('anchorToPage') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="siteScope:acrossWholeSite" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Across whole site {this.selection.siteScope.includes('acrossWholeSite') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="siteScope:anchorToAllSitePages" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Anchored to All Site Pages {this.selection.siteScope.includes('anchorToAllSitePages') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Divider />
                     &nbsp; User view
                    <Dropdown.Item as="button" toggle={false} eventKey="userScope:onlyMe" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Only me {this.selection.userScope.includes('onlyMe') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="userScope:public" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Public {this.selection.userScope.includes('public') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Divider />
                    &nbsp;Type of Annotation
                    <Dropdown.Item as="button" toggle={false} eventKey="annoType:default" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Default {this.selection.annoType.includes('default') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="annoType:to-do" onSelect={eventKey => this.updateSelected(eventKey)}>
                            To-do {this.selection.annoType.includes('to-do') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="annoType:question" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Question/Answer {this.selection.annoType.includes('question') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="annoType:highlight" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Highlight {this.selection.annoType.includes('highlight') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="annoType:navigation" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Navigation {this.selection.annoType.includes('navigation') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="annoType:issue" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Issue {this.selection.annoType.includes('issue') ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="annoType:selectAll" onSelect={eventKey => this.updateSelected(eventKey)}>
                            {this.selection.annoType.length !== 6 ? ("Select All") : ("De-select all")}
                            {/* Select All {this.selection.annoType.includes('issue') ? ("✓") : (null)} */}
                        </Dropdown.Item>
                        <Dropdown.Divider />
                    &nbsp;Time Range
                    <Dropdown.Item as="button" toggle={false} eventKey="timeRange:day" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Past Day {this.selection.timeRange === 'day' ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="timeRange:week" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Past Week {this.selection.timeRange === 'week' ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" toggle={false} eventKey="timeRange:month" onSelect={eventKey => this.updateSelected(eventKey)}>
                            Past Month {this.selection.timeRange === 'month' ? ("✓") : (null)}
                        </Dropdown.Item>
                        <Dropdown.Item as="button" disabled toggle={false} eventKey="timeRange:custom" /*onSelect={eventKey => this.updateSelected(eventKey)} */>
                            Custom Time Range
                        </Dropdown.Item>
                        ...
                        <Dropdown.Item as="button" toggle={false} eventKey="timeRange:all" onSelect={eventKey => this.updateSelected(eventKey)}>
