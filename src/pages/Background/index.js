import './backgroundEventListeners';
import './backgroundTransmitter';
...
// function setUpGetAllAnnotationsByUrlListener(url, annotations, change) {
//   return new Promise((resolve, reject) => {
...
//       chrome.tabs.query({ active: true, currentWindow: true }, tabs => {
//         if (!change && containsObjectWithId(tabs[0].id, tabAnnotationCollect)) {
...
// function promiseToComeBack(url, annotations, change) {
//   return new Promise((resolve, reject) => {
...
//       publicListener = setUpGetAllAnnotationsByUrlListener(changeInfo.url, annotations, true);
//       privateListener = promiseToComeBack(changeInfo.url, annotations, true);
//     }
//   }
// );
...
//     publicListener = setUpGetAllAnnotationsByUrlListener(request.url, annotations, false);
//     privateListener = promiseToComeBack(request.url, annotations, false);
