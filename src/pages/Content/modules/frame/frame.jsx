...
export class Frame extends Component {
  ...
  componentDidMount() {
    ...
    try {
      ...
      // let widthObj = localStorage.getItem('doc-annotator-sidebar-width');
      // if (widthObj !== undefined) {
      //   this.setState({ width: JSON.parse(widthObj).width });
      // }
    } catch (e) {
      chrome.storage.sync.remove(['doc-annotator-sidebar-width']);
      // localStorage.removeItem('doc-annotator-sidebar-width');
    }
